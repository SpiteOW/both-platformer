...
namespace UnitySampleAssets._2D
{
    ...
    public class PlatformerCharacter2D : MonoBehaviour
    {
		...
		Transform playerGraphics; 				// Reference to the graphics so we can change directionManager 
        ...
        private void Start()
        {
            ...
            {
                Debug.LogError("THIS IS WHY WE WWRITE ERROR MESSAGES: No audioManager found");
            }
        }
